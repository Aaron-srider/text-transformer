...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `artifact_share_operation`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `artifact_share_operation_permission`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `artifact_share_permission`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `detail` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `device_lib`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `device_template_entry`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `device_template_entry_data_type`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `device_template_required_field`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `pageCollection_menu`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `page_collection`  (
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `role_pageCollection`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `role_id` int(11) NOT NULL,
  `pageCollection_id` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `user_action_log_record`  (
